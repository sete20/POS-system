    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <li><a href="{{route('dashboard.welcome')}}"><i class="fa fa-dashboard"></i>@lang('site.dashboard')</a></li>
                <li><a href="{{ route('dashboard.products.create') }}"> @lang('site.products')</a></li>
...
<div class="form-group">
<img src="{{ asset('uploads/product_images/default.png') }}"  style="width: 100px; border-radios:50px;" class="img-thumbnail image-preview" alt="">
</div>
                        ...
                        <div class="form-group">
                            <label>@lang('site.Expiration_date')</label>
